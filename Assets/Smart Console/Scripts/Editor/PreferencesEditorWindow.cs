...
namespace ED.SC.Editor
{
	public class PreferencesEditorWindow : EditorWindow
	{
		...
		private GUIContent k_SaveConsoleOutputContent = new GUIContent("Save Output on Quit", "This represents the state of automatic save of output on quitting application in the Smart Console.");
		...
		private bool m_SaveConsoleOutput;
		// End settings
		...
		private void OnEnable()
		{
			...
			{
				m_Icon = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Smart Console/Sprites/SmartConsoleLogo.png");
			...
			{
				m_Preferences = AssetDatabase.LoadAssetAtPath<SmartConsolePreferences>("Assets/Smart Console/Themes/SC.Prefs.asset");
		...
		private void OnGUI()
		{
			...
			m_SaveConsoleOutput = EditorGUILayout.Toggle(k_SaveConsoleOutputContent, m_SaveConsoleOutput);
		...
		private void LoadPreferences()
		{
			...
			m_SaveConsoleOutput = m_Preferences.SaveConsoleOutput;
		...
		private void SavePreferences()
		{
			...
			m_Preferences.SaveConsoleOutput = m_SaveConsoleOutput;
